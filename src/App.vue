    ...
    <section class="work">
      ...
      <div class="projects">
        <div class="card">
          ...
          <div class="card-content">
            <h3>lc3 vm</h3>
            <p>vm based on lc3 architecture</p>
        ...
        <div class="card">
          ...
          <div class="card-content">
            <h3>Pixarch</h3>
            <p>Arch linux rice based on pixel theme</p>
      ...
      <section class="skills">
        <div class="social">
          ...
          <div class="skill" id="cn">
            <a
              href="https://www.linkedin.com/in/aarnav-panchal-0923952b7/"
              target="_blank"
            >
              <img src="/src/assets/icons/ico/linkedin.svg" alt="linkedin"
            /></a>
          </div>
        </div>
      </section>
